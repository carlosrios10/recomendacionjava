...
import com.isistan.lbsn.agregation.AgregationHarmonicMean;
...
//			ItemModel itemModel = new ItemModel(MyProperties.getInstance().getProperty("databasevenues"));
			...
			DataModel ratingLiked = new FileDataModel(new File(MyProperties.getInstance().getProperty("databaseratingliked")));
			DataModel ratingCat = new FileDataModel(new File(MyProperties.getInstance().getProperty("databaseratingabstraccioncate")));
...
//			UserSimilarity similitudOverlap  = new ScoringOverlap(ratingModel);
...
//			ScoringOverlap scoringOverlap  = new ScoringOverlap(ratingModel);
			...
			UserSimilarity simlilitudCoseno  = new UncenteredCosineSimilarity(ratingModel);
			UserSimilarity similitudPearson = new PearsonCorrelationSimilarity(ratingCat);
			Scoring sc = new ScoringOverlap(ratingLiked);
			Scoring sc2 = new ScoringOverlap(ratingCat);
			
			UserSimilarity ahm = new AgregationHarmonicMean(similitudPearson,sc);
...
//			UserSimilarity userDistanciaNet  = new ScoringDistanciaNetwork(grafoModel,MEAN_PATH_FOURSQUARE);
//			
...
//			String resulPath = MyProperties.getInstance().getProperty("resultadosprocesar");
			...
			//calcularMatrizSimilitud(ratingModel,userVisitas,PATH_RESULTADO+"yelp_user_interseccion_visitas.csv");
			//calcularMatrizSimilitudParallel(ratingModel,userVisitas,PATH_RESULTADO+"user_interseccion_visitas_matriz_sentimiento.csv");
			//calcularMatrizSimilitudParallel(ratingModel,scoringLRModel2,PATH_RESULTADO+"user_interseccion_LR2_matriz_sentimiento.csv");
			//calcularMatrizSimilitudParallel(ratingModel,userPathNet,PATH_RESULTADO+"user_userPathNet.csv");
			calcularMatrizSimilitud(ratingModel,similitudes,PATH_RESULTADO+"yelp_agregation_matriz_estrella2.csv");
			//calcularMatrizSimilitud(ratingModel1,similitudesEnGrafoSocial,PATH_RESULTADO+"goodness_grafosocial_similitudes.csv");
			//calcularMatrizSimilitud(ratingModel1,similitudesMatrizRivewTemporales,PATH_RESULTADO+"goodness_simi_tmp_categoria_matriz_sentimiento.csv");
