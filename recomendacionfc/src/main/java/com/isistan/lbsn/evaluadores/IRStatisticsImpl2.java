...
public final class IRStatisticsImpl2 implements IRStatistics, Serializable {
  ...
  IRStatisticsImpl2(double precision, double recall, double fallOut, double ndcg, double reach) {
