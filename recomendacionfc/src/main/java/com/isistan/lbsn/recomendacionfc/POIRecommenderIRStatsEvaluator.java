...
public class POIRecommenderIRStatsEvaluator implements
	  ...
	  public POIRecommenderIRStatsEvaluator() {
	    this(new GenericRelevantItemsDataSplitter());
	  }

	  public POIRecommenderIRStatsEvaluator(RelevantItemsDataSplitter dataSplitter) {
