...
public class ExperimentosSeleccionStateCountyPonderacionScoring {
...
//		configuraciones.add(new Configuracion(150,SimilarityAlgorithmFactory.SimAlg.COSENO,0.6,TypeNeigh.K_NEIGHBORHOOD_GRUPO_NIVEL_1,-1,-1,
//				ScoringType.SCORING_LR2_FOURSQUARE,AgregationType.ONLY_SCORE));
//		configuraciones.add(new Configuracion(200,SimilarityAlgorithmFactory.SimAlg.COSENO,0.7,TypeNeigh.K_NEIGHBORHOOD_GRUPO_NIVEL_1,-1,-1,
//				ScoringType.SCORING_LR2_FOURSQUARE,AgregationType.ONLY_SCORE));
//		configuraciones.add(new Configuracion(250,SimilarityAlgorithmFactory.SimAlg.COSENO,0.8,TypeNeigh.K_NEIGHBORHOOD_GRUPO_NIVEL_1,-1,-1,
//				ScoringType.SCORING_LR2_FOURSQUARE,AgregationType.ONLY_SCORE));
...
//		configuraciones.add(new Configuracion(150,SimilarityAlgorithmFactory.SimAlg.COSENO,0.6,TypeNeigh.K_NEIGHBORHOOD_GRUPO_NIVEL_2,-1,-1,
//				ScoringType.SCORING_LR2_FOURSQUARE,AgregationType.ONLY_SCORE));
//		configuraciones.add(new Configuracion(200,SimilarityAlgorithmFactory.SimAlg.COSENO,0.7,TypeNeigh.K_NEIGHBORHOOD_GRUPO_NIVEL_2,-1,-1,
//				ScoringType.SCORING_LR2_FOURSQUARE,AgregationType.ONLY_SCORE));
//		configuraciones.add(new Configuracion(250,SimilarityAlgorithmFactory.SimAlg.COSENO,0.8,TypeNeigh.K_NEIGHBORHOOD_GRUPO_NIVEL_2,-1,-1,
//				ScoringType.SCORING_LR2_FOURSQUARE,AgregationType.ONLY_SCORE));
...
//				ScoringType.SCORING_LR2_FOURSQUARE,AgregationType.ONLY_SCORE));	
		...
		log.info("INICIA - evaluacion seleccion en state county ponderaciones scorings");
		...
		Util.exportarResultadoCsv(resultados, "fourq_resultados_seleccion_statecounty_ponderacionredvisitas_scoring_matriz_tips");
