...
//
//		configuraciones.add(new Configuracion(5,SimilarityAlgorithmFactory.SimAlg.COSENO,0.6,TypeNeigh.K_NEIGHBORHOOD,-1,-1,
//				ScoringType.SCORING_DISTANCIA_NETWORK_YELP,AgregationType.ONLY_SCORE));		
//		configuraciones.add(new Configuracion(10,SimilarityAlgorithmFactory.SimAlg.COSENO,0.6,TypeNeigh.K_NEIGHBORHOOD,-1,-1,
//				ScoringType.SCORING_DISTANCIA_NETWORK_YELP,AgregationType.ONLY_SCORE));
//		configuraciones.add(new Configuracion(20,SimilarityAlgorithmFactory.SimAlg.COSENO,0.7,TypeNeigh.K_NEIGHBORHOOD,-1,-1,
//				ScoringType.SCORING_DISTANCIA_NETWORK_YELP,AgregationType.ONLY_SCORE));
...
//		configuraciones.add(new Configuracion(5,SimilarityAlgorithmFactory.SimAlg.COSENO,0.6,TypeNeigh.K_NEIGHBORHOOD,-1,-1,
//				ScoringType.USER_OVERLAP_LIKED,AgregationType.HARMONIC_MEAN,SimilarityAlgorithmFactory.SimAlg.PEARSON));		
//		configuraciones.add(new Configuracion(10,SimilarityAlgorithmFactory.SimAlg.COSENO,0.6,TypeNeigh.K_NEIGHBORHOOD,-1,-1,
//				ScoringType.USER_OVERLAP_LIKED,AgregationType.HARMONIC_MEAN,SimilarityAlgorithmFactory.SimAlg.PEARSON));
//		configuraciones.add(new Configuracion(20,SimilarityAlgorithmFactory.SimAlg.COSENO,0.7,TypeNeigh.K_NEIGHBORHOOD,-1,-1,
//				ScoringType.USER_OVERLAP_LIKED,AgregationType.HARMONIC_MEAN,SimilarityAlgorithmFactory.SimAlg.PEARSON));
...
//
//		configuraciones.add(new Configuracion(5,SimilarityAlgorithmFactory.SimAlg.COSENO,0.6,TypeNeigh.K_NEIGHBORHOOD,-1,-1,
//				ScoringType.USER_OVERLAP_LIKED_HATED,AgregationType.HARMONIC_MEAN,SimilarityAlgorithmFactory.SimAlg.PEARSON));		
//		configuraciones.add(new Configuracion(10,SimilarityAlgorithmFactory.SimAlg.COSENO,0.6,TypeNeigh.K_NEIGHBORHOOD,-1,-1,
//				ScoringType.USER_OVERLAP_LIKED_HATED,AgregationType.HARMONIC_MEAN,SimilarityAlgorithmFactory.SimAlg.PEARSON));
//		configuraciones.add(new Configuracion(20,SimilarityAlgorithmFactory.SimAlg.COSENO,0.7,TypeNeigh.K_NEIGHBORHOOD,-1,-1,
//				ScoringType.USER_OVERLAP_LIKED_HATED,AgregationType.HARMONIC_MEAN,SimilarityAlgorithmFactory.SimAlg.PEARSON));
...
//		
//		configuraciones.add(new Configuracion(5,SimilarityAlgorithmFactory.SimAlg.COSENO,0.6,TypeNeigh.K_NEIGHBORHOOD,-1,-1,
//				ScoringType.CERCANIA_USUARIO_USUARIO,AgregationType.HARMONIC_MEAN,SimilarityAlgorithmFactory.SimAlg.PEARSON));		
//		configuraciones.add(new Configuracion(10,SimilarityAlgorithmFactory.SimAlg.COSENO,0.6,TypeNeigh.K_NEIGHBORHOOD,-1,-1,
//				ScoringType.CERCANIA_USUARIO_USUARIO,AgregationType.HARMONIC_MEAN,SimilarityAlgorithmFactory.SimAlg.PEARSON));
//		configuraciones.add(new Configuracion(20,SimilarityAlgorithmFactory.SimAlg.COSENO,0.7,TypeNeigh.K_NEIGHBORHOOD,-1,-1,
//				ScoringType.CERCANIA_USUARIO_USUARIO,AgregationType.HARMONIC_MEAN,SimilarityAlgorithmFactory.SimAlg.PEARSON));
...
//		
//		configuraciones.add(new Configuracion(5,SimilarityAlgorithmFactory.SimAlg.COSENO,0.6,TypeNeigh.K_NEIGHBORHOOD,-1,-1,
//				ScoringType.CERCANIA_USUARIO_ITEM,AgregationType.HARMONIC_MEAN,SimilarityAlgorithmFactory.SimAlg.PEARSON));		
//		configuraciones.add(new Configuracion(10,SimilarityAlgorithmFactory.SimAlg.COSENO,0.6,TypeNeigh.K_NEIGHBORHOOD,-1,-1,
//				ScoringType.CERCANIA_USUARIO_ITEM,AgregationType.HARMONIC_MEAN,SimilarityAlgorithmFactory.SimAlg.PEARSON));
//		configuraciones.add(new Configuracion(20,SimilarityAlgorithmFactory.SimAlg.COSENO,0.7,TypeNeigh.K_NEIGHBORHOOD,-1,-1,
//				ScoringType.CERCANIA_USUARIO_ITEM,AgregationType.HARMONIC_MEAN,SimilarityAlgorithmFactory.SimAlg.PEARSON));
...
//		
//		configuraciones.add(new Configuracion(5,SimilarityAlgorithmFactory.SimAlg.COSENO,0.6,TypeNeigh.K_NEIGHBORHOOD,-1,-1,
//				ScoringType.SCORING_OVERLAP_ABSTRACCION_CATEGORY,AgregationType.HARMONIC_MEAN,SimilarityAlgorithmFactory.SimAlg.PEARSON));		
//		configuraciones.add(new Configuracion(10,SimilarityAlgorithmFactory.SimAlg.COSENO,0.6,TypeNeigh.K_NEIGHBORHOOD,-1,-1,
//				ScoringType.SCORING_OVERLAP_ABSTRACCION_CATEGORY,AgregationType.HARMONIC_MEAN,SimilarityAlgorithmFactory.SimAlg.PEARSON));
//		configuraciones.add(new Configuracion(20,SimilarityAlgorithmFactory.SimAlg.COSENO,0.7,TypeNeigh.K_NEIGHBORHOOD,-1,-1,
//				ScoringType.SCORING_OVERLAP_ABSTRACCION_CATEGORY,AgregationType.HARMONIC_MEAN,SimilarityAlgorithmFactory.SimAlg.PEARSON));
...
//		
//		configuraciones.add(new Configuracion(5,SimilarityAlgorithmFactory.SimAlg.COSENO,0.6,TypeNeigh.K_NEIGHBORHOOD,-1,-1,
//				ScoringType.SCORING_OVERLAP_WEEKDAYNAME,AgregationType.HARMONIC_MEAN,SimilarityAlgorithmFactory.SimAlg.PEARSON));		
//		configuraciones.add(new Configuracion(10,SimilarityAlgorithmFactory.SimAlg.COSENO,0.6,TypeNeigh.K_NEIGHBORHOOD,-1,-1,
//				ScoringType.SCORING_OVERLAP_WEEKDAYNAME,AgregationType.HARMONIC_MEAN,SimilarityAlgorithmFactory.SimAlg.PEARSON));
//		configuraciones.add(new Configuracion(20,SimilarityAlgorithmFactory.SimAlg.COSENO,0.7,TypeNeigh.K_NEIGHBORHOOD,-1,-1,
//				ScoringType.SCORING_OVERLAP_WEEKDAYNAME,AgregationType.HARMONIC_MEAN,SimilarityAlgorithmFactory.SimAlg.PEARSON));
...
//		
//		configuraciones.add(new Configuracion(5,SimilarityAlgorithmFactory.SimAlg.COSENO,0.6,TypeNeigh.K_NEIGHBORHOOD,-1,-1,
//				ScoringType.SCORING_OVERLAP_WEEKORWEEKEND,AgregationType.HARMONIC_MEAN,SimilarityAlgorithmFactory.SimAlg.PEARSON));		
//		configuraciones.add(new Configuracion(10,SimilarityAlgorithmFactory.SimAlg.COSENO,0.6,TypeNeigh.K_NEIGHBORHOOD,-1,-1,
//				ScoringType.SCORING_OVERLAP_WEEKORWEEKEND,AgregationType.HARMONIC_MEAN,SimilarityAlgorithmFactory.SimAlg.PEARSON));
//		configuraciones.add(new Configuracion(20,SimilarityAlgorithmFactory.SimAlg.COSENO,0.7,TypeNeigh.K_NEIGHBORHOOD,-1,-1,
//				ScoringType.SCORING_OVERLAP_WEEKORWEEKEND,AgregationType.HARMONIC_MEAN,SimilarityAlgorithmFactory.SimAlg.PEARSON));
...
//		
//		configuraciones.add(new Configuracion(5,SimilarityAlgorithmFactory.SimAlg.COSENO,0.6,TypeNeigh.K_NEIGHBORHOOD,-1,-1,
//				ScoringType.SCORING_OVERLAP_BY_CATEGORY_WEEKDAYNAME,AgregationType.HARMONIC_MEAN,SimilarityAlgorithmFactory.SimAlg.PEARSON));		
//		configuraciones.add(new Configuracion(10,SimilarityAlgorithmFactory.SimAlg.COSENO,0.6,TypeNeigh.K_NEIGHBORHOOD,-1,-1,
//				ScoringType.SCORING_OVERLAP_BY_CATEGORY_WEEKDAYNAME,AgregationType.HARMONIC_MEAN,SimilarityAlgorithmFactory.SimAlg.PEARSON));
//		configuraciones.add(new Configuracion(20,SimilarityAlgorithmFactory.SimAlg.COSENO,0.7,TypeNeigh.K_NEIGHBORHOOD,-1,-1,
//				ScoringType.SCORING_OVERLAP_BY_CATEGORY_WEEKDAYNAME,AgregationType.HARMONIC_MEAN,SimilarityAlgorithmFactory.SimAlg.PEARSON));
...
//		
//		configuraciones.add(new Configuracion(5,SimilarityAlgorithmFactory.SimAlg.COSENO,0.6,TypeNeigh.K_NEIGHBORHOOD,-1,-1,
//				ScoringType.SCORING_OVERLAP_BY_CATEGORY_WEEKORWEEKEND,AgregationType.HARMONIC_MEAN,SimilarityAlgorithmFactory.SimAlg.PEARSON));		
//		configuraciones.add(new Configuracion(10,SimilarityAlgorithmFactory.SimAlg.COSENO,0.6,TypeNeigh.K_NEIGHBORHOOD,-1,-1,
//				ScoringType.SCORING_OVERLAP_BY_CATEGORY_WEEKORWEEKEND,AgregationType.HARMONIC_MEAN,SimilarityAlgorithmFactory.SimAlg.PEARSON));
//		configuraciones.add(new Configuracion(20,SimilarityAlgorithmFactory.SimAlg.COSENO,0.7,TypeNeigh.K_NEIGHBORHOOD,-1,-1,
//				ScoringType.SCORING_OVERLAP_BY_CATEGORY_WEEKORWEEKEND,AgregationType.HARMONIC_MEAN,SimilarityAlgorithmFactory.SimAlg.PEARSON));
...
//				ScoringType.SCORING_OVERLAP_BY_CATEGORY_WEEKORWEEKEND,AgregationType.HARMONIC_MEAN,SimilarityAlgorithmFactory.SimAlg.PEARSON));
		...
		configuraciones.add(new Configuracion(5,SimilarityAlgorithmFactory.SimAlg.COSENO,0.6,TypeNeigh.K_NEIGHBORHOOD,-1,-1,
				ScoringType.SCORING_COSENO_NETWORK,AgregationType.HARMONIC_MEAN,SimilarityAlgorithmFactory.SimAlg.PEARSON));		
		configuraciones.add(new Configuracion(10,SimilarityAlgorithmFactory.SimAlg.COSENO,0.6,TypeNeigh.K_NEIGHBORHOOD,-1,-1,
				ScoringType.SCORING_COSENO_NETWORK,AgregationType.HARMONIC_MEAN,SimilarityAlgorithmFactory.SimAlg.PEARSON));
		configuraciones.add(new Configuracion(20,SimilarityAlgorithmFactory.SimAlg.COSENO,0.7,TypeNeigh.K_NEIGHBORHOOD,-1,-1,
				ScoringType.SCORING_COSENO_NETWORK,AgregationType.HARMONIC_MEAN,SimilarityAlgorithmFactory.SimAlg.PEARSON));
		...
		configuraciones.add(new Configuracion(5,SimilarityAlgorithmFactory.SimAlg.COSENO,0.6,TypeNeigh.K_NEIGHBORHOOD,-1,-1,
				ScoringType.SCORING_JACCARD_NETWORK,AgregationType.HARMONIC_MEAN,SimilarityAlgorithmFactory.SimAlg.PEARSON));		
		configuraciones.add(new Configuracion(10,SimilarityAlgorithmFactory.SimAlg.COSENO,0.6,TypeNeigh.K_NEIGHBORHOOD,-1,-1,
				ScoringType.SCORING_JACCARD_NETWORK,AgregationType.HARMONIC_MEAN,SimilarityAlgorithmFactory.SimAlg.PEARSON));
		configuraciones.add(new Configuracion(20,SimilarityAlgorithmFactory.SimAlg.COSENO,0.7,TypeNeigh.K_NEIGHBORHOOD,-1,-1,
				ScoringType.SCORING_JACCARD_NETWORK,AgregationType.HARMONIC_MEAN,SimilarityAlgorithmFactory.SimAlg.PEARSON));
...
//		// la distancia hasta 3?
		configuraciones.add(new Configuracion(5,SimilarityAlgorithmFactory.SimAlg.COSENO,0.6,TypeNeigh.K_NEIGHBORHOOD,-1,-1,
				ScoringType.SCORING_DISTANCIA_NETWORK_YELP,AgregationType.HARMONIC_MEAN,SimilarityAlgorithmFactory.SimAlg.PEARSON));		
		configuraciones.add(new Configuracion(10,SimilarityAlgorithmFactory.SimAlg.COSENO,0.6,TypeNeigh.K_NEIGHBORHOOD,-1,-1,
				ScoringType.SCORING_DISTANCIA_NETWORK_YELP,AgregationType.HARMONIC_MEAN,SimilarityAlgorithmFactory.SimAlg.PEARSON));
		configuraciones.add(new Configuracion(20,SimilarityAlgorithmFactory.SimAlg.COSENO,0.7,TypeNeigh.K_NEIGHBORHOOD,-1,-1,
				ScoringType.SCORING_DISTANCIA_NETWORK_YELP,AgregationType.HARMONIC_MEAN,SimilarityAlgorithmFactory.SimAlg.PEARSON));
		...
		/// combinaciones LR  
//		configuraciones.add(new Configuracion(5,SimilarityAlgorithmFactory.SimAlg.COSENO,0.6,TypeNeigh.K_NEIGHBORHOOD,-1,-1,
//				ScoringType.SCORING_LR2_YELP,AgregationType.ONLY_SCORE));		
//		configuraciones.add(new Configuracion(10,SimilarityAlgorithmFactory.SimAlg.COSENO,0.6,TypeNeigh.K_NEIGHBORHOOD,-1,-1,
//				ScoringType.SCORING_LR2_YELP,AgregationType.ONLY_SCORE));
//		configuraciones.add(new Configuracion(20,SimilarityAlgorithmFactory.SimAlg.COSENO,0.7,TypeNeigh.K_NEIGHBORHOOD,-1,-1,
//				ScoringType.SCORING_LR2_YELP,AgregationType.ONLY_SCORE));
...
//				ScoringType.SCORING_LR2_YELP,AgregationType.ONLY_SCORE));	
		...
		Util.exportarResultadoCsv(resultados, "yelp_resultados_ponderacion_hmean_pearson_redvisitas_matriz_tips");
