...
//				ScoringType.SCORING_LR2_FOURSQUARE,AgregationType.ONLY_SCORE));
		...
		log.info("INICIA - evaluacion seleccion en zonas ponderaciones scorings");
		...
		Util.exportarResultadoCsv(resultados, "fourq_resultados_seleccionZonas_ponderacionredvisitas_scorings_matriz_tips");
