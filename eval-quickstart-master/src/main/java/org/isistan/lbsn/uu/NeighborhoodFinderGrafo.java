...
public class NeighborhoodFinderGrafo implements NeighborFinder {

	private static final Logger logger = LoggerFactory.getLogger(NeighborhoodFinderGrafo.class);
     ...
     */
    @Inject
    public NeighborhoodFinderGrafo(RatingVectorPDAO rvd, DataAccessObject dao,UserSimilarity sim,UserVectorNormalizer norm,@UserSimilarityThreshold Threshold thresh,@DistBetweenZonas double radioNeig) {
        similarity = sim;
        normalizer = norm;
        rvDAO = rvd;
        this.dao = dao;
