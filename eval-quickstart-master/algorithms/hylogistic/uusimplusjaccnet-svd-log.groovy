...
import org.isistan.lbsn.uu.NeighborhoodFinderGrafoCosenoNet
...
def uusimplusjaccnet = {
	bind ItemScorer to UserUserItemScorer
	bind VectorNormalizer to MeanCenteringVectorNormalizer
	set NeighborhoodSize to 100
	bind NeighborFinder to NeighborhoodFinderGrafoCosenoNet
...
addComponent RecommenderConfigurationList.create(svd, uusimplusjaccnet)
